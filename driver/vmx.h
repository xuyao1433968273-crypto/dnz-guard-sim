...
/* 4KB EPT 页表项（拆 2MB 大页用）——老师: HV_EptSplitLargePage */
typedef struct _VMX_PTE
{
    union
    {
        struct
        {
            ...
            UINT64 Reserved : 3;
            UINT64 IgnorePat : 1;
            UINT64 Large : 1;          /* 必须为 0（4KB 页） */
            UINT64 Accessed : 1;
            UINT64 Dirty : 1;
            UINT64 UserModeExecute : 1;
            UINT64 SoftwareUse : 1;
            UINT64 PageFrameNumber : 36; /* 物理地址 >> 12 */
            UINT64 ReservedHigh : 4;
            UINT64 SoftwareUseHigh : 11;
            UINT64 SupressVme : 1;
        };
...
static_assert(sizeof(VMX_PTE) == sizeof(UINT64), "PTE Size Mismatch");
